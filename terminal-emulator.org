...
Update this section and remove ~:tangle no~ to use customize fonts. See [[https://github.com/ryanoasis/nerd-fonts/discussions/1103][this
post]] for the differences of the 3 variations of nerd fonts, i.e. (nerd font,
...
#+begin_src lua :tangle ~/.wezterm.lua :tangle no
  ...
  -- Fallback font for missing glyphs (say ) or if the primary font is
