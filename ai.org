...
** User-Specific "Global" NPM Installation
...
Please note, this is a standard, one-time setup for ~npm~. Once configured, it
will work for any package you install this way.
