...
#+begin_src toml :tangle ~/.config/aerospace/aerospace.toml :mkdirp yes
  ...
  [mode.move.binding]
  h = ['exec-and-forget ~/.config/aerospace/aerospace-swap.sh left']
  j = ['exec-and-forget ~/.config/aerospace/aerospace-swap.sh down']
  k = ['exec-and-forget ~/.config/aerospace/aerospace-swap.sh up']
  l = ['exec-and-forget ~/.config/aerospace/aerospace-swap.sh right']
...
#+begin_src bash :tangle ~/.config/aerospace/aerospace-swap.sh :shebang "#!/usr/bin/env bash"
  # aerospace is installed in /opt/homebrew/bin
