...
#+begin_src toml :tangle ~/.config/aerospace/aerospace.toml :mkdirp yes
  ...
  cmd-ctrl-alt-shift-s = 'mode stack'
  cmd-ctrl-alt-shift-a = 'mode app'
  cmd-ctrl-alt-shift-c = 'mode summon'
  ...
  # App-select mode (was Hyper-a → j/k/l/o)
  [mode.app.binding]
  j = ['exec-and-forget open -a wezterm.app', 'mode main']
  k = ['exec-and-forget open -a "google chrome.app"', 'mode main']
  l = ['exec-and-forget open -a slack.app', 'mode main']
  i = ['exec-and-forget open -a emacs.app', 'mode main']
  o = ['exec-and-forget open -a safari.app', 'mode main']
  esc = 'mode main'
  ctrl-g = 'mode main'
