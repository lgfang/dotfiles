...
#+begin_src emacs-lisp
  (use-package agent-shell
    ...
    (defconst my/work-macbook-regexp "^M-"
      "Regular expression to identify my work MacBook from its hostname.")
    ...
    (agent-shell-preferred-agent-config
     (cond ((string-match-p my/work-macbook-regexp (system-name)) 'claude-code)
           (t 'opencode)))
    (agent-shell-opencode-default-model-id
     (cond ((string-match-p my/work-macbook-regexp (system-name)) "grove-openai/gpt-5.5")
           (t "deepseek/deepseek-v4-pro"))))
#+end_src
