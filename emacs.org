...
Prerequisites:
- Install AI agent(s)  of your choice:
  + Claude Code
    #+begin_src sh
  ...
  + OpenCode
    ...
    #+end_src
- Install Agent Client Protocol (ACP) agents accordingly:
  #+begin_src bash
    npm install -g @agentclientprotocol/claude-agent-acp
    npm install -g @agentclientprotocol/codex-acp
    # opencode CLI includes an ACP, so no extra installation needed
  #+end_src
...
#+begin_src emacs-lisp
  (use-package agent-shell
    ...
    :preface
    (defun my/start-agent-shell (&optional arg)
      "Run `agent-shell'. With prefix ARG (C-u), select the directory from a pre-defined set."
      (interactive "P")
      (if arg
    ...
    :bind (("C-c a" . my/start-agent-shell)
    ...
    (agent-shell-opencode-default-model-id
     ...
     (if my/work-machine-p "grove-openai/gpt-5.5" "deepseek/deepseek-v4-pro"))
    )
#+end_src
