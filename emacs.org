...
Apart from the above I need no explicit Emacs configuration in this regard yet.
...
Why: consistency in
- approaches to switch context (i.e. windows/panes)
- approaches to manage windows/panes.
- color themes
...
This function works is based on treesit (=json-ts-mode=)
#+begin_src emacs-lisp
  (use-package json-ts-mode
    :commands
