...
As I typically run the same Emacs instance for days, an accidental =C-x C-c=
would cost me the whole session (there is no desktop saving); setting
=confirm-kill-emacs= to =yes-or-no-p= makes killing Emacs a deliberate act
