...
#+begin_src emacs-lisp
  ...
  also allows entering any path with directory-name autocompletion."
    ...
    (agent-shell-opencode-default-model-id
     ...
     (if my/work-machine-p "grove-misc/fw-glm-5.2" "deepseek/deepseek-v4-pro"))
    )
#+end_src
    ...
    (let (
      ...
      (if my/work-machine-p
          (progn
            ...
            (setq-default gptel-model 'gpt-5.5))
        (progn
          (setq-default gptel-backend deepseek)
          (setq-default gptel-model 'deepseek-v4-pro)
          ))))
#+end_src
