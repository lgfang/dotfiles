...
#+begin_src emacs-lisp
  ...
  entering any path with directory-name autocompletion."
    ...
    ;; Anthropic
    (agent-shell-anthropic-default-model-id (my/anthropic-model-id-from-name "GLM 5.3 Flash"))
    ...
    (let (
          ...
          (fireworks
           ...
           (gptel-make-openai "Fireworks"
             ...
             :models '(accounts/fireworks/models/glm-5p3-flash)
      ...
      (if my/work-machine-p
          (progn
            ...
            (setq-default gptel-model 'accounts/fireworks/models/glm-5p3-flash))
        (progn
