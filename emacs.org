...
#+begin_src emacs-lisp
  (use-package agent-shell
    ...
    (defun my/agent-shell (&optional arg)
      "A wrapper of `agent-shell'. With prefix ARG (C-u), select the directory from a pre-defined set."
      (interactive "P")
      (if arg
          (let* ((dirs '("~/source/project1/" "~/source/project2/" "~/source/project3/"))
                 (chosen-dir (completing-read "Select agent-shell directory: " dirs nil nil))
