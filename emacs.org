...
#+begin_src emacs-lisp
  ...
  entering any path with directory-name autocompletion."
    ...
    ;; Anthropic
    (agent-shell-anthropic-default-model-id (my/anthropic-model-id-from-name "Fable"))
    ...
    (agent-shell-opencode-default-model-id
     ...
     (if my/work-machine-p "grove-misc/fw-glm-5.2" "deepseek/deepseek-v4-flash"))
    )
#+end_src
  ...
  (use-package gptel
    ...
    (let (
      ...
      (if my/work-machine-p
          (progn
            (setq-default gptel-backend grove)
            (setq-default gptel-model 'gpt-5.6-sol))
        (progn
