...
- Install the Claude Code command line tool following the [[https://docs.anthropic.com/en/docs/claude-code/overview#get-started-in-30-seconds][official
  documentation]].
- Configure Claude to use AWS Bedrock. Below is an example
...
2. [Optional] Verify the authentication information
   #+begin_src bash
     aws sts get-caller-identity --profile ai-coder-llm
   #+end_src

3. Start Claude Code in Emacs
...
#+begin_src emacs-lisp
  (use-package emacs-lisp-mode
    :mode ("\\.el\\'"         ; Auto-activate for .el files
           "\\.eli\\'"        ; For .eli (Emacs Lisp Info) files
           "\\.emacs\\'")     ; The old configuration file name
    )
#+end_src
...
#+begin_src emacs-lisp
  (use-package yaml-pro
    ...
    :bind (:map yaml-pro-ts-mode-map
                ;; Prefer standard `yank' as `yaml-pro-ts-yank' never worked as I
                ;; expected.
                ("C-y" . yank)
