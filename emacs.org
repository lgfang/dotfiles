...
#+begin_src emacs-lisp
  (use-package kubel
    :commands kubel
    :init                          ; Must set the value before loading the package
    (setq-default kubel-namespace "devprod-platform"))
#+end_src
...
#+begin_src emacs-lisp
  (use-package agent-shell
    ...
    ;; Choose agent and model based on work vs. personal laptop.
